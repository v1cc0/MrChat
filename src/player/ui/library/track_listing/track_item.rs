...
use crate::player::ui::components::icons::{PLAY, PLUS, STAR, STAR_FILLED, icon};
use crate::player::ui::models::PlaylistEvent;
use crate::{
    player::library::{db::LibraryAccess, types::Track},
    player::playback::{
