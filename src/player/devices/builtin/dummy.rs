...
impl OutputStream for DummyStream {
    fn submit_frame(
        &mut self,
        frame: crate::player::media::playback::PlaybackFrame,
    ) -> Result<(), crate::player::devices::errors::SubmissionError> {
    ...
    fn reset(&mut self) -> Result<(), crate::player::devices::errors::ResetError> {
        debug!("Stream reset.");
        Ok(())
    }
